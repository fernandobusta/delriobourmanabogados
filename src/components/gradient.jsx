...
export function HeroImageBackground({ className, ...props }) {
  return (
    <div
      {...props}
      className={clsx(
        ...
        'absolute inset-2 bottom-0 rounded-4xl ring-1 ring-inset ring-black/5',
      )}
      style={{
        backgroundImage: "url('/abogados/libreria.jpg')",
      }}
    />
  )
}
